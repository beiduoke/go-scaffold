...
func State(v int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldEQ(FieldState, v))
}
...
func StateNEQ(v int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldNEQ(FieldState, v))
}

// StateIn applies the In predicate on the "state" field.
func StateIn(vs ...int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldIn(FieldState, vs...))
}

// StateNotIn applies the NotIn predicate on the "state" field.
func StateNotIn(vs ...int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldNotIn(FieldState, vs...))
}

// StateGT applies the GT predicate on the "state" field.
func StateGT(v int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldGT(FieldState, v))
}

// StateGTE applies the GTE predicate on the "state" field.
func StateGTE(v int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldGTE(FieldState, v))
}

// StateLT applies the LT predicate on the "state" field.
func StateLT(v int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldLT(FieldState, v))
}

// StateLTE applies the LTE predicate on the "state" field.
func StateLTE(v int32) predicate.Tenant {
	return predicate.Tenant(sql.FieldLTE(FieldState, v))
}
