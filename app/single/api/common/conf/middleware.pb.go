...
var file_common_conf_middleware_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x50, 0x61, 0x74, 0x68, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69,
	...
	0x6e, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f,
...
func file_common_conf_middleware_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_conf_middleware_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Middleware_Localize); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_conf_middleware_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Middleware_Authorizer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_conf_middleware_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Middleware_Authorizer_Casbin); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
