...
const (
	PostService_ListPost_FullMethodName        = "/admin.v1.PostService/ListPost"
	PostService_CreatePost_FullMethodName      = "/admin.v1.PostService/CreatePost"
	PostService_GetPost_FullMethodName         = "/admin.v1.PostService/GetPost"
	PostService_UpdatePost_FullMethodName      = "/admin.v1.PostService/UpdatePost"
	PostService_DeletePost_FullMethodName      = "/admin.v1.PostService/DeletePost"
	PostService_UpdatePostState_FullMethodName = "/admin.v1.PostService/UpdatePostState"
)
...
func (c *postServiceClient) UpdatePostState(ctx context.Context, in *UpdatePostStateRequest, opts ...grpc.CallOption) (*UpdatePostStateResponse, error) {
	out := new(UpdatePostStateResponse)
	err := c.cc.Invoke(ctx, PostService_UpdatePostState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPostServiceServer) UpdatePostState(context.Context, *UpdatePostStateRequest) (*UpdatePostStateResponse, error) {
...
func _PostService_UpdatePostState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdatePostStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostServiceServer).UpdatePostState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PostService_UpdatePostState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).UpdatePostState(ctx, req.(*UpdatePostStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.v1.PostService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PostService_UpdatePostState_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "admin/v1/post.proto",
}
