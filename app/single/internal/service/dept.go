...
var _ v1.DeptServiceServer = (*DeptService)(nil)
...
// GetTreeDept 列表部门-树形
func (s *DeptService) ListDeptTree(ctx context.Context, in *v1.ListDeptTreeRequest) (*v1.ListDeptTreeResponse, error) {
...
// ListDept 列表-部门角色
func (s *DeptService) ListDept(ctx context.Context, in *v1.ListDeptRequest) (*v1.ListDeptResponse, error) {
...
// CreateDept 创建部门角色
func (s *DeptService) CreateDept(ctx context.Context, in *v1.CreateDeptRequest) (*v1.CreateDeptResponse, error) {
...
// UpdateDept 创建部门角色
func (s *DeptService) UpdateDept(ctx context.Context, in *v1.UpdateDeptRequest) (*v1.UpdateDeptResponse, error) {
	v := in.GetData()
...
func (s *DeptService) UpdateDeptState(ctx context.Context, in *v1.UpdateDeptStateRequest) (*v1.UpdateDeptStateResponse, error) {
	v := in.GetData()
...
// GetDept 获取部门角色
func (s *DeptService) GetDept(ctx context.Context, in *v1.GetDeptRequest) (*v1.Dept, error) {
...
// DeleteDept 删除部门角色
func (s *DeptService) DeleteDept(ctx context.Context, in *v1.DeleteDeptRequest) (*v1.DeleteDeptResponse, error) {
