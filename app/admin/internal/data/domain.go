...
func (r *DomainRepo) toPackageModel(d *biz.DomainPackage) *SysDomainPackage {
	if d == nil {
		return nil
	}
	...
	for _, v := range d.Menus {
		sysDomainPackage.Menus = append(sysDomainPackage.Menus, *r.menu.toModel(v))
	}
...
func (r *DomainRepo) toPackageBiz(d *SysDomainPackage) *biz.DomainPackage {
	if d == nil {
		return nil
	}
	...
	for _, v := range d.Menus {
		bizDomainPackage.Menus = append(bizDomainPackage.Menus, r.menu.toBiz(&v))
	}
...
func (r *DomainRepo) PackageSave(ctx context.Context, g *biz.DomainPackage) (*biz.DomainPackage, error) {
	d := r.toPackageModel(g)
	result := r.data.DB(ctx).Create(d)
	return r.toPackageBiz(d), result.Error
}
