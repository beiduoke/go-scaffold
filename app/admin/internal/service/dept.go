...
// ListDept 列表-部门角色
func (s *AdminService) ListDept(ctx context.Context, in *v1.ListDeptReq) (*v1.ListDeptReply, error) {
...
func (s *AdminService) UpdateDeptState(ctx context.Context, in *v1.UpdateDeptStateReq) (*v1.UpdateDeptStateReply, error) {
	v := in.GetData()
