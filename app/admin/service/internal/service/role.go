...
// ListRole 列表-角色
func (s *RoleService) ListRole(ctx context.Context, in *v1.ListRoleRequest) (*v1.ListRoleResponse, error) {
...
// CreateRole 创建角色
func (s *RoleService) CreateRole(ctx context.Context, in *v1.CreateRoleRequest) (*v1.CreateRoleResponse, error) {
...
// UpdateRole 修改角色
func (s *RoleService) UpdateRole(ctx context.Context, in *v1.UpdateRoleRequest) (*v1.UpdateRoleResponse, error) {
	v := in.GetData()
...
func (s *RoleService) UpdateRoleState(ctx context.Context, in *v1.UpdateRoleStateRequest) (*v1.UpdateRoleStateResponse, error) {
	v := in.GetData()
...
// GetRole 获取角色
func (s *RoleService) GetRole(ctx context.Context, in *v1.GetRoleRequest) (*v1.Role, error) {
...
// DeleteRole 删除角色
func (s *RoleService) DeleteRole(ctx context.Context, in *v1.DeleteRoleRequest) (*v1.DeleteRoleResponse, error) {
...
func (s *RoleService) ListRoleMenu(ctx context.Context, in *v1.ListRoleMenuRequest) (*v1.ListRoleMenuResponse, error) {
	id := in.GetId()
...
func (s *RoleService) HandleRoleMenu(ctx context.Context, in *v1.HandleRoleMenuRequest) (*v1.HandleRoleMenuResponse, error) {
	data := in.GetData()
...
func (s *RoleService) ListRoleDept(ctx context.Context, in *v1.ListRoleDeptRequest) (*v1.ListRoleDeptResponse, error) {
	id := in.GetId()
...
func (s *RoleService) GetRoleDataScope(ctx context.Context, in *v1.GetRoleDataScopeRequest) (*v1.GetRoleDataScopeResponse, error) {
	id := in.GetId()
...
func (s *RoleService) HandleRoleDataScope(ctx context.Context, in *v1.HandleRoleDataScopeRequest) (*v1.HandleRoleDataScopeResponse, error) {
	var depts []*biz.Dept
