...
const OperationApiUpdateDeptState = "/api.server.v1.Api/UpdateDeptState"
...
func RegisterApiHTTPServer(s *http.Server, srv ApiHTTPServer) {
	...
	r.PUT("/v1/depts/{id}/state", _Api_UpdateDeptState0_HTTP_Handler(srv))
...
func _Api_UpdateDeptState0_HTTP_Handler(srv ApiHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationApiUpdateDeptState)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ApiHTTPClientImpl) UpdateDeptState(ctx context.Context, in *UpdateDeptStateReq, opts ...http.CallOption) (*UpdateDeptStateReply, error) {
	var out UpdateDeptStateReply
	pattern := "/v1/depts/{id}/state"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationApiUpdateDeptState))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in.Data, &out, opts...)
	if err != nil {
		return nil, err
