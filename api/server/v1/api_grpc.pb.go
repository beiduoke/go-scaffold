...
const (
	...
	Api_UpdateDeptState_FullMethodName            = "/api.server.v1.Api/UpdateDeptState"
...
func (c *apiClient) UpdateDeptState(ctx context.Context, in *UpdateDeptStateReq, opts ...grpc.CallOption) (*UpdateDeptStateReply, error) {
	out := new(UpdateDeptStateReply)
	err := c.cc.Invoke(ctx, Api_UpdateDeptState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedApiServer) UpdateDeptState(context.Context, *UpdateDeptStateReq) (*UpdateDeptStateReply, error) {
...
func _Api_UpdateDeptState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateDeptStateReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServer).UpdateDeptState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Api_UpdateDeptState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).UpdateDeptState(ctx, req.(*UpdateDeptStateReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Api_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Api_UpdateDeptState_Handler,
		},
		{
