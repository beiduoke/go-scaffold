...
func RegisterAdminHTTPServer(s *http.Server, srv AdminHTTPServer) {
	...
	r.POST("/admin/v1/auth/login", _Admin_PassLogin0_HTTP_Handler(srv))
	r.POST("/admin/v1/auth/passLogin", _Admin_PassLogin1_HTTP_Handler(srv))
...
func _Admin_PassLogin1_HTTP_Handler(srv AdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in PassLoginReq
		if err := ctx.Bind(&in.Auth); err != nil {
			return err
...
func _Admin_ListMenuTree1_HTTP_Handler(srv AdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListMenuTreeReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
