...
// ListResource 列表资源
func (s *AdminService) ListResource(ctx context.Context, in *protobuf.PagingReq) (*protobuf.PagingReply, error) {
...
// CreateResource 创建资源
func (s *AdminService) CreateResource(ctx context.Context, in *v1.CreateResourceReq) (*v1.CreateResourceReply, error) {
...
// UpdateResource 修改资源
func (s *AdminService) UpdateResource(ctx context.Context, in *v1.UpdateResourceReq) (*v1.UpdateResourceReply, error) {
	v := in.GetData()
...
// GetResource 获取资源
func (s *AdminService) GetResource(ctx context.Context, in *v1.GetResourceReq) (*v1.Resource, error) {
...
// DeleteResource 删除资源
func (s *AdminService) DeleteResource(ctx context.Context, in *v1.DeleteResourceReq) (*v1.DeleteResourceReply, error) {
